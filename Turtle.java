 ...
 */
 ...
 public class Turtle implements Runnable, ActionListener, MouseListener, MouseMotionListener, KeyListener, ComponentListener, MouseWheelListener
 {
      ...
      */
      ...
      public class TurtleConcurrentDrawing {

        public static void main(String[] args) {
            Turtle bob = new Turtle();
    
            
            Thread triangleThread = new Thread(new TriangleTask(bob));
            Thread squareThread = new Thread(new SquareTask(bob));
            Thread circleThread = new Thread(new CircleTask(bob));
        ...
        // triangle
        static class TriangleTask implements Runnable {
            private Turtle bob;
    
            public TriangleTask(Turtle bob) {
                this.bob = bob;
            }
        ...
        // circle
        static class CircleTask implements Runnable {
            private Turtle bob;
    
            public CircleTask(Turtle bob) {
                this.bob = bob;
            }
